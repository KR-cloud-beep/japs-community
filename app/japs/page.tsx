...
export default function JapsHome() {
  return <main className={styles.home}>
    <header className={styles.nav}><Link className={styles.logo} href="/japs"><span>J</span> JAPS</Link><nav><a href="#about">잽스 소개</a><a href="#features">서비스</a><a href="#vision">방향</a><Link href="/terms">약관</Link></nav><Link className="primary small" href="/">커뮤니티 바로가기 →</Link></header>
    ...
    <footer className={styles.footer}><strong><span>J</span> JAPS</strong><p>사람과 이야기를 연결하는 공간.</p><div><Link href="/">잽스 커뮤니티</Link> · <Link href="/terms">이용약관</Link> · <Link href="/privacy">개인정보처리방침</Link></div></footer>
  </main>;
}
